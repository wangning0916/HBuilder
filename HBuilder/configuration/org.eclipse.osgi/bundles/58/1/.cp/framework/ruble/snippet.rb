...
module Ruble
  ...
  class Snippet < Command
    ...
    def locationType=(locationType)
      @jobj.locationType = locationType
    end
    
    def needApplyReContentAssist
      @jobj.needApplyReContentAssist
    end

    def needApplyReContentAssist=(needApplyReContentAssist)
      @jobj.needApplyReContentAssist = needApplyReContentAssist
    end
